...
<body>
    <nav class="navbar navbar-expand-lg bg-white shadow-sm py-3">
        <div class="container-fluid px-4">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#topNavUser"
                aria-controls="topNavUser" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="d-flex app-shell">
        <aside class="sidebar p-3 d-none d-md-block">
            ...
            <nav class="nav flex-column gap-1">
                ...
                <a class="nav-link active" href="{{ route('user.barang') }}">Barang</a>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <small
                                                        class="text-muted">Rp{{ number_format($item->hargabarang, 0, ',', '.') }}</small>
                                                </div>
                                            </div>
                                        </td>
